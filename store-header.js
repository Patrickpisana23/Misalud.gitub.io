...
function addItemToCart(title, price, imageSrc, contenido, cantidad) {
    ...
    var btnContinuar = `<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal0001" style="padding-left:10%;padding-right:10%;border-radius:20px;background-color:#043CAA;color:white">Continuar</button>`
